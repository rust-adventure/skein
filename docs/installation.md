...
1. Drag [this link](/releases/bevy_skein-0.1.16.zip?repository=.%2Findex.json) onto Blender to add the registry
...
![add a registry](/images/introduction/add-registry.avif)
